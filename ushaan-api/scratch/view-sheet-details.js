...
async function main() {
  ...
  try {
    ...
    // Let's get sheet 46 (July 2026)
    const resSheet = await client.query('SELECT * FROM monthly_sheet WHERE id = 46');
    ...
    console.log('\n--- Member Payment Statuses for July Sheet ---');
