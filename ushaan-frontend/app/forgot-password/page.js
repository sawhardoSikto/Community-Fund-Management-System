        ...
        <div className="text-center mb-8">
          ...
          {sent ? (
            <>
              ...
              <p className="text-emerald-400 font-bold text-lg mt-2">OTP পাঠানো হয়েছে!</p>
              <p className="text-slate-400 text-sm mt-1">পাসওয়ার্ড রিসেট পেজে নিয়ে যাচ্ছি...</p>
            </>
          ) : (
            <>
              <p className="text-slate-400 text-sm mt-2">পাসওয়ার্ড রিসেট করতে ইমেইল দিন</p>
            </>
          )}
        </div>
        ...
        {!sent && (
          <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label className="block text-xs font-semibold text-slate-300 mb-2">ইমেইল ঠিকানা</label>
